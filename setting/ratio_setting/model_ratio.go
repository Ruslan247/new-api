...
var defaultModelPrice = map[string]float64{
	...
	// flux-3-video pricing is unconfirmed (BFL has not published official
	// pricing for this early-access model as of Aug 2026); adjust in the
	// admin panel once real pricing is known.
	"flux-3-video":                  0.5,
	"gpt-4-gizmo-*":                 0.1,
	"mj_video":                      0.8,
	"mj_imagine":                    0.1,
